  ...
  <div class="login-container">
    <el-row>
      <el-col :lg="14" :md="11" :sm="24" :xl="14" :xs="24">
        <div style="opacity: 0; user-select: none">占位符</div>
      </el-col>
        ...
        >
          ...
          <el-form-item prop="username" style="margin-top: 40px">
            <el-input
              ...
              v-focus
              :placeholder="translateTitle('アカウント')"
              tabindex="1"
              type="text"
            >
              <template #prefix>
          ...
          <el-form-item prop="password">
            <el-input
              ...
              :placeholder="translateTitle('パスワード')"
              tabindex="2"
              :type="passwordType"
          ...
          <!-- 検証コード検証ロジックは自己開発する必要があり、検証コード機能提案コメントが必要でない場合 -->
  ...
  export default {
    ...
    data() {
      const validateUsername = (rule, value, callback) => {
        if ('' === value)
          callback(
            new Error(this.translateTitle('アカウントを入力してください'))
          )
        else callback()
      }
      const validatePassword = (rule, value, callback) => {
        if (!isPassword(value))
          callback(
            new Error(
              this.translateTitle('パスワードは 6 文字以上にする必要があります')
            )
          )
        else callback()
      }
    ...
    mounted() {
      ...
      // this.form.password = 'caj123456789'
